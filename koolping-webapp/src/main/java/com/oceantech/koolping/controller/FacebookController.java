...
public class FacebookController {
	...
	public String getProfile(ModelMap model) {
		try {
            ...
            model.addAttribute("linkedPagesInfo", facebook.likeOperations().getPagesLiked().get(1));
            System.out.println("***"+ facebook.likeOperations().getPagesLiked().get(0).getCategory());
            System.out.println("***"+ facebook.likeOperations().getPagesLiked().get(0).getLikes());
